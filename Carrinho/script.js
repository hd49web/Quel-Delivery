...
function carrinhoVazio(){
    ...
    if (items === null) {
        ...
        carrinhoExibir.innerHTML = `
        <div class="noProduct">
            <div class="small-title">Seu carrinho do Seu DELIVERY está vazio</div>
...
function mensagem(){
    ...
    var mensagemWhats = 'https://api.whatsapp.com/send?l=pt_BR&phone=5535984238252&text=Boa%20noite,%20gostaria%20de%20pedir:';
